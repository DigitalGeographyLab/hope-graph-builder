...
hma_poly = geom_utils.project_geom(gpd.read_file('extent_data/HMA.geojson')['geometry'][0])
export_otp_data_to_gpkg: bool = False
export_decomposed_igraphs_to_gpkg: bool = False
export_final_graph_to_gpkg: bool = False
